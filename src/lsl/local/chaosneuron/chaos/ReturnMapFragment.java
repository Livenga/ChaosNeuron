...
public class ReturnMapFragment extends Fragment 
  ...
  private final static String TAG    = "NeuronModel ReturnMap";
  ...
  public void onClick(View v) {
    ...
    switch(v.getId()) {
      case lsl.local.chaosneuron.R.id.btn_run_neuron_model_time:
        setValues();
        dataset = ChaosNeuronModel.ReturnMap(num_times, initial_y);
        break;
    }

    if(dataset != null) {
      graphTimeSeries.setPointSize(3.0f);
      graphTimeSeries.setData(dataset, false);
    }
    dataset = null;
  }
